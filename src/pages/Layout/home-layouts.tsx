...
import HomeHeaderMenu from "../../components/home/home-header.components";
...
const HomePageLayout = () => {
    return (
        <>
            ...
            <footer className="bg-teal-800 rounded-lg  shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
                <p className="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
                    &copy; 2019-2022 <NavLink to="https://flowbite.com/" className="hover:underline" target="_blank">Flowbite.com</NavLink>. All rights reserved.
                </p>
