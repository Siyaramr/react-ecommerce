...
const HomePage: React.FC = () => {
    return (
        <>
            ...
            < div className="max-w-screen-xl my-5 px-4 mx-auto 2xl:px-0 py-3">
                <div className="flex items-center justify-between">
                <Card className="max-w-sm">
                    <img
                        alt="Meaningful alt text for an image that is not purely decorative"
                        src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front.svg"/>
                    < NavLink to="/category-detail/electronic" className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Electronic
                    </NavLink>
                ...
                <Card className="max-w-sm">
                    <img
                        alt="Meaningful alt text for an image that is not purely decorative"
                        src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front.svg"/>
                    <NavLink to="/category-detail/digital-watch"className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        digital Watch
                    </NavLink>
                ...
                <Card className="max-w-sm">
                    <img
                        alt="Meaningful alt text for an image that is not purely decorative"
                        src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front.svg"/>
                    <NavLink to="/category-detail/smart-phone" className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Smart Phone
                    </NavLink>
                ...
                <Card className="max-w-sm">
                    <img
                        alt="Meaningful alt text for an image that is not purely decorative"
                        src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front.svg"/>
                    <NavLink to="/category-detail/pc" className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        pc
                    </NavLink>
                        ...
                        <div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <div className="pt-6">
                                    <div className="mb-4 flex items-center justify-between gap-4">
                                        <span className="me-2 rounded bg-teal-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"> Up to 35% off </span>
                                    ...
                                    <div className="mt-4 flex items-center justify-between gap-4">
                                        ...
                                        <button type="button" className="inline-flex items-center rounded-lg bg-teal-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                            ...
                            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <div className="pt-6">
                                    ...
                                    <div className="mt-4 flex items-center justify-between gap-4">
                                        <p className="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">Rs799</p>
                            ...
                            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <div className="pt-6">
                                    ...
                                    <div className="mt-4 flex items-center justify-between gap-4">
                                        ...
                                        <button type="button" className="inline-flex items-center rounded-lg bg-teal-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-teal-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                            <svg className="-ms-2 me-2 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4h1.5L8 16m0 0h8m-8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm.75-3H7.5M11 7H6.312M17 4v6m-3-3h6" />
                                            </svg>
                                            Add to cart
